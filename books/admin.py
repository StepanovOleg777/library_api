...
class UserAdmin(admin.ModelAdmin):
    list_display = ('username', 'last_name', 'first_name', 'library_card_number', 'email')
...
class BookAdmin(admin.ModelAdmin):
    list_display = ('title', 'get_authors', 'isbn', 'publication_year', 'quantity', 'available_quantity', 'status')
