...
class Book(models.Model):
    ...
    pages = models.IntegerField(validators=[MinValueValidator(1)], verbose_name="Количество страниц")
    description = models.TextField(blank=True, verbose_name="Описание")
    quantity = models.IntegerField(validators=[MinValueValidator(0)], verbose_name="Общее количество экземпляров")
    available_quantity = models.IntegerField(validators=[MinValueValidator(0)], verbose_name="Доступно экземпляров")
...
class BookBorrow(models.Model):
    ...
    """
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='borrowed_books', verbose_name="Читатель")
    book = models.ForeignKey(Book, on_delete=models.CASCADE, related_name='borrowed_records', verbose_name="Книга")
